...
{{--                                    <span class="newsletter-marketing-text">... و دریافت--}}
{{--												<strong>کد تخفیف 50 درصدی برای اولین خرید</strong>--}}
{{--											</span>--}}
{{--                                </div>--}}
{{--                                <!-- .newsletter-header -->--}}
...
{{--                                        <button class="button" type="button">عضویت</button>--}}
{{--                                    </form>--}}
{{--                                </div>--}}
{{--                                <!-- .newsletter body -->--}}
{{--                            </div>--}}
...
{{--                                <i class="fa fa-facebook"></i> فیس بوک</a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="sm-icon-label-link nav-link" href="#">--}}
{{--                                <i class="fa fa-twitter"></i> توییتر</a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="sm-icon-label-link nav-link" href="#">--}}
{{--                                <i class="fa fa-google-plus"></i> گوگل +</a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="sm-icon-label-link nav-link" href="#">--}}
{{--                                <i class="fa fa-vimeo-square"></i> ویمو</a>--}}
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a class="sm-icon-label-link nav-link" href="#">--}}
...
{{--                                    <address class="footer-contact-address">ایران، تهران، خیابان فلانی، کوچه فلانی نسب</address>--}}
...
{{--										</span>--}}
{{--                                <div class="media-body">--}}
{{--                                    <h5 class="footer-payment-info-title">ما از پرداختهای ایمن استفاده می کنیم</h5>--}}
...
{{--                                        <h6 class="footer-secured-by-title">امینت پرداخت با:</h6>--}}
...
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">سیستم ها و لپ تاپ ها</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">دوربین های عکاسی</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">گوشی های موبایل و تبلت</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">کنسول های بازی</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">تلویزیون</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">لوازم خودرو</a>--}}
{{--                                        </li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
...
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">پرینترها</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">سیستم های صوتی</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">هدفون ها</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">لوازم جانبی</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">کتاب ها</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="shop.html">ساعت های هوشمند</a>--}}
{{--                                        </li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
...
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="login-and-register.html">حساب من</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="track-your-order.html">رهگیری سفارشات</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
...
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="terms-and-conditions.html">شرایط استفاده</a>--}}
{{--                                        </li>--}}
{{--                                        <li class="menu-item">--}}
{{--                                            <a href="faq.html">پرسش های پاسخ</a>--}}
{{--                                        </li>--}}
{{--                                    </ul>--}}
{{--                                </div>--}}
...
{{--        <div class="site-info">--}}
{{--            <div class="col-full">--}}
{{--                <div class="copyright">کپی رایت © 2017 <a href="home-v1.html">بازار فناوری</a>. کلیه حقوق محفوظ است.</div>--}}
{{--                <!-- .copyright -->--}}
{{--                <div class="credit">ساخته شده توسط--}}
{{--                    <i class="fa fa-heart"></i> فلان فلانی نسب.</div>--}}
{{--                <!-- .credit -->--}}
{{--            </div>--}}
{{--            <!-- .col-full -->--}}
{{--        </div>--}}
                ...
                <div class="footer-contact">
                    <div class="footer-logo">
                        <a href="{{route('home')}}" class="custom-logo-link" rel="home">
                            <img alt="logo" src="{{asset('assets/common/images/logo/logo.png')}}" style="background-color: #fd6602">
                        </a>
                    </div>
...
{{--                                    </address>--}}
                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <div class="footer-secure-by-info">
                                        ...
                                        <ul class="footer-secured-by-icons">
                                            <li class="nav-item">
                                                <img width="100" src="{{asset('assets/common/images/saman.jfif')}}" alt="norton">
                                            </li>
                                            <li class="nav-item">
                                                <img width="100" src="{{asset('assets/common/images/sepehr.jfif')}}" alt="mcafee">
                                            </li>
                                            <li class="nav-item">
                                                <a referrerpolicy="origin" target="_blank" href="https://trustseal.enamad.ir/?id=214144&amp;Code=rQdhA3Db7tS7FayR3Kpa"><img referrerpolicy="origin" src="https://Trustseal.eNamad.ir/logo.aspx?id=214144&amp;Code=rQdhA3Db7tS7FayR3Kpa" alt="" style="cursor:pointer" id="rQdhA3Db7tS7FayR3Kpa"></a>
                                            </li>
                                        </ul>
                                    </div>
        ...
        <div class="site-info">
            <div class="col-full">
                <div class="copyright">
                    <strong style="color: white">© Designing & Development By : <a href="https://patterndp.ir">Pattern Group</a></strong>
                </div>

                <div class="credit">ساخته شده توسط
                    <i class="fa fa-heart"></i> Pattern Group
                </div>
...
<script type="text/javascript" src="{{asset('assets/frontend/js/hidemaxlistitem.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/frontend/js/jquery-ui.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/frontend/js/jquery.easing.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/frontend/js/scrollup.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/frontend/js/jquery.waypoints.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/frontend/js/waypoints-sticky.min.js')}}"></script>
